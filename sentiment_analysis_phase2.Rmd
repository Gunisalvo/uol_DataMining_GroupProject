...
scores.classifier <- knn(train=scores.train, test=scores.test, cl=scores.train_scores, k=10)

library(gmodels)

CrossTable(x=scores.test_scores, y=scores.classifier, prop.chisq=FALSE)

scatter.smooth(x=scores.train_pn$positive, y=scores.train_scores, main="Sentiment ~ Score")
